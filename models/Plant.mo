model processPlant
    ...
    mixerModule mixer0(redeclare package Medium = Medium);
    sourceModule source0(redeclare package Medium = Medium);
    sourceModule source1(redeclare package Medium = Medium);
    sourceModule source2(redeclare package Medium = Medium);
    sinkModule sink0(redeclare package Medium = Medium);
    
equation
    connect(source0.port_out0,mixer0.port_in0);
    connect(source1.port_out0,mixer0.port_in1);
    connect(source2.port_out0,mixer0.port_in2);    
    connect(mixer0.port_out0,sink0.port_in0);
